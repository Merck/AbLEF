...
def animate_plot_cdrs (i):
    ...
    cmap = 'PuRd'
    cax = ax.imshow(cdrs_dist_matrix
                    , cmap = plt.cm.get_cmap(cmap)
                    , interpolation = 'nearest', origin="lower")
    if i == 0:
        fig.colorbar(cax, cmap = plt.cm.get_cmap(cmap))
...
def animate_plot_cdr3s (i):
    ...
    cmap = 'Reds'
    cax = ax.imshow(cdr3s_dist_matrix
                    , cmap = plt.cm.get_cmap(cmap)
                    , interpolation = 'nearest', origin="lower")
    if i == 0:
        fig.colorbar(cax, cmap = plt.cm.get_cmap(cmap))
...
colors_maps = ['plasma', 'cividis', 'magma', 'viridis']
colors_cdrs = ['PuRd', 'Reds']
slices = ['all', 'cdrs', 'cdr3s']
...
for slice in range(len(slices)):
    for k in range(len(maps)):
        ...
        for i in range(len(dirs)):
            ...
            if maps[k] == 'CaDIST' and slices[slice] == 'all':
                ani = FuncAnimation(fig,
                                    animate_plot,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'CaDIST' and slices[slice] == 'cdrs':
                ani = FuncAnimation(fig,
                                    animate_plot_cdrs,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'CaDIST' and slices[slice] == 'cdr3s':
                ani = FuncAnimation(fig,
                                    animate_plot_cdr3s,
                                    frames=len(pdbs),
                                    init_func=init,
            ...
            elif maps[k] == 'CbDIST' and slices[slice] == 'all':
                ani = FuncAnimation(fig,
                                    animate_plot1,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'CbDIST' and slices[slice] == 'cdrs':
                ani = FuncAnimation(fig,
                                    animate_plot1_cdrs,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'CbDIST' and slices[slice] == 'cdr3s':
                ani = FuncAnimation(fig,
                                    animate_plot1_cdr3s,
                                    frames=len(pdbs),
                                    init_func=init,
            ...
            elif maps[k] == 'roidDIST' and slices[slice] == 'all':
                ani = FuncAnimation(fig,
                                    animate_plot2,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'roidDIST' and slices[slice] == 'cdrs':
                ani = FuncAnimation(fig,
                                    animate_plot2_cdrs,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'roidDIST' and slices[slice] == 'cdr3s':
                ani = FuncAnimation(fig,
                                    animate_plot2_cdr3s,
                                    frames=len(pdbs),
                                    init_func=init,
            ...
            elif maps[k] == 'scoidDIST' and slices[slice] == 'all':
                ani = FuncAnimation(fig,
                                    animate_plot3,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'scoidDIST' and slices[slice] == 'cdrs':
                ani = FuncAnimation(fig,
                                    animate_plot3_cdrs,
                                    frames=len(pdbs),
                                    init_func=init,
                                    interval=100)
            elif maps[k] == 'scoidDIST' and slices[slice] == 'cdr3s':
                ani = FuncAnimation(fig,
                                    animate_plot3_cdr3s,
                                    frames=len(pdbs),
                                    init_func=init,
            ...
            ani.save('%s.gif' % (slices[slice] + '_' + dirs_name), fps=10)
            plt.show()
            os.chdir(cwd)
